...
const MIR = ({ consumption, mir }) => {
    ...
    return (
        <section className='mt-4'>
            ...
            <div className='flex w-full items-center gap-10 text-2xl tracking-wide font-semibold'>
                <h1 className='border-b-2 border-primary w-fit'>Your impact score is :</h1>
                <span className=''>{(mir.score / (mir.score + consumption.totalCarbonEmitted * 365 * duration)) * 100}</span>
            </div>
        </section>
    )
}
